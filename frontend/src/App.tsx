...
import { fetchGameConfig } from "@/lib/api";
import { setBidExpirationDays } from "@/lib/utils";
...
const App = () => {
  useEffect(() => {
    fetchGameConfig().then((config) => setBidExpirationDays(config.bid_expiration_days));
  }, []);
